...
const timelinePage = getTimelinePage();

export const metadata: Metadata = {
  title: timelinePage.metaTitle,
  description: timelinePage.metaDescription,
};
 ...
 *
 * Hero copy lives in content/timeline-page.mdx (separate filename from
 * the content/timeline/ folder collection so Decap doesn't trip).
 */
